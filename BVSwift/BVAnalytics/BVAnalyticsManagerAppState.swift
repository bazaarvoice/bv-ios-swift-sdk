...
extension BVAnalyticsManager {
  ...
  internal static var defaultAppState: [String: String] = {
    var eventData = [
      BVAnalyticsConstants.clKey: BVAnalyticsConstants.lifecycleKey,
      BVAnalyticsConstants.typeKey: BVAnalyticsConstants.mobileAppKey,
      BVAnalyticsConstants.sourceKey:
    ...
    guard let config: BVAnalyticsConfiguration =
      BVManager.sharedManager.getConfiguration() else {
        BVLogger.sharedLogger.analytics(
          BVLogMessage(BVAnalyticsConstants.bvProduct, msg:
